...
void global::setPlayer(Player *ply) { player = ply; }

void global::setSceneManager(SceneManager *scene) { mSceneMgr = scene; }
...
Player *global::getPlayer() { return player; }
...
OgreNewt::World *global::getWorld() { return mWorld; }

void global::setRoot(Ogre::Root *mRoot) { root = mRoot; }
Ogre::Root *global::getRoot() { return root; }

SceneManager *global::getSceneManager() { return mSceneMgr; }
