...
class SoftwareOcclusionCulling
    : public Singleton<SoftwareOcclusionCulling>,
      public managerTemplate // Singleton initialize, another template for Run3
                             // Game Engine compliance
{
public:
  SoftwareOcclusionCulling(String manName) {
  ...
  {
    LogManager::getSingleton().logMessage("Passing entity to culling:" +
                                          ent->getName());
    zps.push_back(ent);
  }
