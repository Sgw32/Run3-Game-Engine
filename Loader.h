...
public:
  ...
  struct shadowListener : public Ogre::SceneManager::Listener {
    ...
    void shadowTextureCasterPreViewProj(Ogre::Light *light, Ogre::Camera *cam,
      ...
      // yeah.  simplistic, but it works nicely.  this is the function I was
      // talking about you ignoring above in the Mgr declaration.
      ...
      // shadow 15 units - the rest of it should be attenuated away, and not
      // rendered)
    }
    ...
    void preFindVisibleObjects(Ogre::SceneManager *,
                               ...
                               Ogre::Viewport *) {}
    void postFindVisibleObjects(Ogre::SceneManager *,
                                Ogre::SceneManager::IlluminationRenderStage,
                                Ogre::Viewport *) {}
  } shadowCameraUpdater;
