...
// The render operation that will be called each frame in the custom composition
// pass This is the class that will send the actual render calls of the spheres
// (point lights), cones (spotlights) and quads (directional lights) after the
// GBuffer has been constructed
