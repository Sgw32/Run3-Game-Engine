...
public:
  CutScene();
  ~CutScene();
  void assign(Vector3 pos, Real length, String name, bool freezebefore,
  ...
  void setNoDestroy(bool noD) { mNoDestroy = noD; }
  void enableSkipAbility() { skipMessage = true; }
