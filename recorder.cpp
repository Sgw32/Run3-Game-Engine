...
// program proceed to do this is to first record the time delays between each
// keyboard hit,those time delays are saved into and array and later,they are
// saved into a file. Once the the time delays are saved the program can use
// them for writing any given text. this code is copyrighted and has limited
// warranty. //****************
//=========================================================================================
#include "recorder.h"
...
//==============================================================
void print_string(const char *string, std::vector<double> time_delay,
                  size_t linePos) {}
