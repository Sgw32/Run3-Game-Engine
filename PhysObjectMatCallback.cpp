...
int PhysObjectMatCallback::userProcess() {
  ...
  if (y > 100000) {
    ...
    // BulletHitManager::getSingleton().addBulletEffect(get_pos(m_body1),1.0f,5,"bulletHit3");
    // //TODO FIX IT
  }
  /*if (TIME_SHIFT==0.0f)
          return 0;*/
...
int PhysObjectMatCallback::userBegin() { return 1; }
...
int Ragdoll2RagdollMatCallback::userProcess() { return 0; }