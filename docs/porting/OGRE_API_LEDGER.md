...
| Fixed-function map materials were accepted by D3D9 | Use Ogre `BaseWhite` through RTSS for the Step 6B geometry milestone; keep original assets untouched | `source/gameplay/StaticMap.cpp` | D3D11 bounded runs render and exit cleanly; original material restoration is deferred to Step 9. |
