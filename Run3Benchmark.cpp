...
int Run3Benchmark::benchMarkGetIteration() { return iteration; }
...
void Run3Benchmark::benchMarkStop() { mapAtBenchMark = ""; }
...
bool Run3Benchmark::benchMarkEnabled() { return !(mapAtBenchMark.empty()); }
