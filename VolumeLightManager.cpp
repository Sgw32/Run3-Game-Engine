...
template <>
VolumeLightManager *Ogre::Singleton<VolumeLightManager>::ms_Singleton = 0;

VolumeLightR3::VolumeLightR3() {}

VolumeLightR3::~VolumeLightR3() {}

void VolumeLightR3::create(Vector3 pos, Vector3 dir, Vector3 scale,
                           unsigned int type) {
  if (type == Direct) {
  }
  if (type == Halo) {
...
void VolumeLightManager::createVolumeLight(Vector3 pos, Vector3 dir,
                                           Vector3 scale, unsigned int type) {
