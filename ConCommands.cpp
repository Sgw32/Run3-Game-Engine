...
void ConCommands::init(Player *ply, Root *mRoot) {
  ...
  AxisAlignedBox aab =
  AxisAlignedBox(Vector3(-7905,-100,-4250),Vector3(-7305,700,-3350));
  trig->init(aab,ply);
...
void ConCommands::Compile() {
  ...
  OgreConsole::getSingleton().addCommand("togglenightvision",
...
void ConCommands::spawnzom(vector<String> &param) {
  ...
  prop.spCPos =
      global::getSingleton().getPlayer()->getFObject() + Vector3(0, 150, 0);
  ...
  LogManager::getSingleton().logMessage(
      "CC: npc passed, all data was got;ready for spawn");
...
void ConCommands::god(vector<String> &param) {
  global::getSingleton().getPlayer()->god =
      !global::getSingleton().getPlayer()->god;
...
void ConCommands::a1gfdo4abfs(vector<String> &param) {
  ...
  OgreConsole::getSingleton().print(
      "~Run3 is MY project! Sgw32 is not a programmer!~");
  OgreConsole::getSingleton().print(
      "And is going to sell it and register as a trademark,");
  OgreConsole::getSingleton().print("REMEMBER!!!111!");
  OgreConsole::getSingleton().print(
      "Those people are idiots and they sucks!!!");
...
void ConCommands::Commodore(vector<String> &param) {
  ...
  CompositorManager::getSingleton().addCompositor(
      global::getSingleton().getCamera()->getViewport(), "Commodore");
  CompositorManager::getSingleton().setCompositorEnabled(
      global::getSingleton().getCamera()->getViewport(), "Commodore", true);
}
void ConCommands::testCompos(vector<String> &param) {
  CompositorManager::getSingleton().addCompositor(
      global::getSingleton().getCamera()->getViewport(), "TestRun3");
  CompositorManager::getSingleton().setCompositorEnabled(
      global::getSingleton().getCamera()->getViewport(), "TestRun3", true);
}

void ConCommands::testCompos2(vector<String> &param) {
  CompositorManager::getSingleton().addCompositor(
      global::getSingleton().getCamera()->getViewport(), param[1]);
  CompositorManager::getSingleton().setCompositorEnabled(
      global::getSingleton().getCamera()->getViewport(), param[1], true);
}

void ConCommands::drug1(vector<String> &param) {
  CompositorManager::getSingleton().addCompositor(
      global::getSingleton().getCamera()->getViewport(), "RunFX1");
  CompositorManager::getSingleton().setCompositorEnabled(
      global::getSingleton().getCamera()->getViewport(), "RunFX1", true);
}
void ConCommands::drug2(vector<String> &param) {
  CompositorManager::getSingleton().addCompositor(
      global::getSingleton().getCamera()->getViewport(), "RunLSD");
  CompositorManager::getSingleton().setCompositorEnabled(
      global::getSingleton().getCamera()->getViewport(), "RunLSD", true);
}
void ConCommands::drug3(vector<String> &param) {
  CompositorManager::getSingleton().addCompositor(
      global::getSingleton().getCamera()->getViewport(), "RunFX3");
  CompositorManager::getSingleton().setCompositorEnabled(
      global::getSingleton().getCamera()->getViewport(), "RunFX3", true);
}
...
void ConCommands::printStats(vector<String> &param) {
  OgreConsole::getSingleton().print(
      "FPS:" + StringConverter::toString(
                   global::getSingleton().getWindow()->getLastFPS()));
  OgreConsole::getSingleton().print(
      "Average:" + StringConverter::toString(
                       global::getSingleton().getWindow()->getAverageFPS()));
  OgreConsole::getSingleton().print(
      "Best:" + StringConverter::toString(
                    global::getSingleton().getWindow()->getBestFPS()));
  OgreConsole::getSingleton().print(
      "Worst:" + StringConverter::toString(
                     global::getSingleton().getWindow()->getWorstFPS()));
  OgreConsole::getSingleton().print(
      "Batch Count" + StringConverter::toString(
                          global::getSingleton().getWindow()->getBatchCount()));
}
...
void ConCommands::Gluk() { HUD::getSingleton().SetGreenEnergy(0.4f); }
...
void ConCommands::changeFOV(vector<String> &param) {
  global::getSingleton().getPlayer()->changeFOV(
      StringConverter::parseReal(param[1]));
}
