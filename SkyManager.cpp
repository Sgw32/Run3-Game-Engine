...
void SkyManager::setSampleNumber(int n) { mSkyXOptions.NumberOfSamples = n; }

void SkyManager::setOuterRadius(Real outr) { mSkyXOptions.OuterRadius = outr; }

void SkyManager::setInnerRadius(Real inrr) { mSkyXOptions.InnerRadius = inrr; }

void SkyManager::setExposure(Real exps) { mSkyXOptions.Exposure = exps; }

void SkyManager::setMie(Real mie) { mSkyXOptions.MieMultiplier = mie; }
...
void SkyManager::create() {
  mSkyX = new SkyX::SkyX(global::getSingleton().getSceneManager(),
                         global::getSingleton().getCamera());
  mSkyX->create();
  mSkyX->getCloudsManager()->add(
      SkyX::CloudLayer::Options(/* Default options */));
