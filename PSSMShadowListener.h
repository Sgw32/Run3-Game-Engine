...
public:
  PSSMShadowListener(Ogre::SceneManager *sm, Ogre::Light *l,
                     Ogre::ShadowCameraSetupPtr s, Ogre::Camera *cam);
  virtual ~PSSMShadowListener() {}
  virtual void shadowTexturesUpdated(size_t numberOfShadowTextures) {};
  virtual void shadowTextureCasterPreViewProj(Ogre::Light *light,
                                              Ogre::Camera *camera,
                                              size_t iteration);
  virtual void shadowTextureReceiverPreViewProj(Ogre::Light *light,
                                                Ogre::Frustum *frustum) {};
  virtual bool sortLightsAffectingFrustum(Ogre::LightList &lightList);

  virtual void
  preFindVisibleObjects(SceneManager *source,
                        Ogre::SceneManager::IlluminationRenderStage irs,
                        Viewport *v) {};
  virtual void
  postFindVisibleObjects(SceneManager *source,
                         Ogre::SceneManager::IlluminationRenderStage irs,
                         Viewport *v) {};
