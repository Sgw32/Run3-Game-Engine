...
#include "MainModules.h" //Âñå ãëîáàëüíûå òàì.
#include "MainUtils.h" //Ôóíêöèè
...
private:
    Real mRotate;          // Êîíñòàíòà âðàùåíèÿ
    Real mMove;            // Êîíñòàíà ïåðåìåùåíèÿ
    bool mContinue;        // Ïðîäîëæàòü ðåíäåðèíã èëè íåò
	bool mConsole;         // Îòêðûòà ëè êîíñîëü
	Real time;				// Âðåìÿ ñ ïðåäûäóùåãî ôðýéìà(íå èñïîëüçóåòñÿ)
    Vector3 mDirection;     // Çíà÷åíèÿ ïåðåìåùåíèÿ â ïðàâèëüíîì íàïðàâëåíèè
	SceneManager *mSceneMgr;   // Òåêóùèé SceneManager
    SceneNode *mCamNode;   // SceneNode, ê êîòîðîìó ïðèñîåäèíåíà òåêóùàÿ Êàìåðà
