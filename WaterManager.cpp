...
WaterManager::WaterManager() { mHydrax = 0; }
...
void WaterManager::create(Vector3 sunPosition, Vector3 sunColor) {
  mHydrax =
      new Hydrax::Hydrax(global::getSingleton().getSceneManager(),
  ...
  // but due to the high number of customizable parameters, since 0.4 version,
  // Hydrax allows save/load config files.
...
void WaterManager::create(Vector3 sunPosition, Vector3 sunColor,
                          String fileName, Vector3 position) {
  mHydrax =
      new Hydrax::Hydrax(global::getSingleton().getSceneManager(),
                         global::getSingleton().getCamera(),
                         global::getSingleton().getWindow()->getViewport(0));
