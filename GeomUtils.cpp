...
void GeomUtils::createSphere(const String &strName, const float radius,
  ...
  createSphere(pSphere->sharedVertexData, pSphereVertex->indexData, radius,
  ...
  pSphere->_setBounds(AxisAlignedBox(Vector3(-radius, -radius, -radius),
...
void GeomUtils::createSphere(VertexData *&vertexData, IndexData *&indexData,
                             float radius, int nRings, int nSegments,
                             bool bNormals, bool bTexCoords) {
