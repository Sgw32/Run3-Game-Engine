...
void Rotating::setDistanceDirection(Ogre::Real distance, Ogre::Vector3 dir,
                                    Ogre::Real speed) {
  dist = distance;
  direction = dir;
  mspeed = speed;
...
void Rotating::setname(String name) { mName = name; }

String Rotating::getname() { return mName; }
