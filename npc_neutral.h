...
public:
  ...
  // HEADSHOT!!!
  void headshot();
  // When NPC moves, rapid changing an animation causes it look strange. So, you
  // need to do a transition between 2 animations.
  void transitFromCurrentAnimation(String newAnim);
  // set newt material

  int getCycle128() { return (int)((int)time256 > 128); }

  int getCycle64() { return (int)(((int)time256) % 128 > 64); }

  int getCycle32() { return (int)(((int)time256) % 64 > 32); }

  int getCycle16() { return (int)(((int)time256) % 32 > 16); }
